...
const CollageOptionsPage = () => {
  ...
  const selectedPhotos = (location.state as LocationState)?.selectedPhotos || [];
  const [activeModal, setActiveModal] = useState<'grid' | 'mockShaadi' | null>(null);
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="sticky top-0 bg-gray-900/80 backdrop-blur-lg z-10">
        <div className="px-4 py-4 flex items-center">
          ...
          <h1 className="ml-4 text-lg font-medium text-white">Choose Collage Style</h1>
        </div>
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        >
          <h2 className="text-xl font-medium text-white mb-2">Custom Grid Collage</h2>
          <p className="text-white/60 text-sm">
            Create a customizable grid layout with borders and colors of your choice.
        ...
        >
          ...
          <p className="text-white/60 text-sm">
            Create an elegant filmstrip-style collage with the Mock Shaadi theme.
            Select 4 of your favorite photos.
          </p>
        </motion.button>
      </div>
